...
<title>CRON - Nuevo mensaje</title>
...
<header class="bg-primary">
  ...
  <section id="main">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
                 <div class="row inbox-redactar-nav"><h4>Nuevo mensaje</h4></div>
                <div class="containermail row">
                
                        
                       <div class="answermail col-lg-12" id="answermail">
                                
                                  <form action="sendMail.php" method="POST">
                                  <div class="form-group">
                                    <label for="exampleFormControlInput1">Para</label>
                                    <input type="email" name="address" class="form-control" id="exampleFormControlInput1" required placeholder="name@example.com">
                                  </div>
                                  <div class="form-group">
                                    <label for="exampleFormControlInput1">Asunto</label>
                                    <input type="text" name="asunto" class="form-control" id="exampleFormControlInput1" required placeholder="Sin asunto">
                                  </div>
                                  <div class="form-group">
                                    <label for="exampleFormControlTextarea1">Mensaje</label>
                                    <textarea name="mensaje" class="form-control" id="exampleFormControlTextarea1" required rows="3" cols="8"></textarea>
                                  </div>
