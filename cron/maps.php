...
<title>CRON - Localización oficinas y laboratorios</title>
      ...
      <div class="row">
        <div class="col-md-4 loginsidebar">
                <ul class="loginmenu">
                         ...
                         <li class="active"><a href="maps.php">WorldwideCRON</a></li>
                </ul>
        </div>
        <div class="col-md-8">
                ...
                <div class="row">
                        <div class="embed-responsive embed-responsive-4by3">
                                <iframe class="embed-responsive-item" src="https://www.google.com/maps/d/u/0/embed?mid=1FSq0_Zvm2duK2BWAaogGuVBPo2jlnwkc" width="640" height="480"></iframe>
                       </div>
               </div>
        </div>
