...
<title>CRON - Mis documentos/Extractos de prensa</title>
        ...
        <div class="col-md-8">
                ...
                <div class="row">
                        <div class="col-md-4 col-sm-6 text-center">
                                <a href="extractos_prensa/file.php?src=entrevistaKobalt" class="link_directorio">
                                        <div class="icon-files file"></div>
                                        <span class="file-name">Entrevista Dra S. Kobalt</span>
                                </a>
                        
                        </div>
                        <div class="col-md-4 col-sm-6 text-center">
                                <a href="extractos_prensa/file.php?src=digitalCNU" class="link_directorio">
                                        <div class="icon-files file"></div>
                                        <span class="file-name">Entrevista DigitalCNU</span>
                                </a>
                        </div>
                        <div class="col-md-4 col-sm-6 text-center">
                                <a href="extractos_prensa/file.php?src=productoresArroz" class="link_directorio">
                                        <div class="icon-files file"></div>
                                        <span class="file-name">Informe Producción de arroz</span>
                                </a>
                        </div>
               ...
               <div class="row">
                        <div class="col-md-4 col-sm-6 text-center">
                                <a href="extractos_prensa/file.php?src=entrevistaTutuni" class="link_directorio">
                                        <div class="icon-files file"></div>
                                        <span class="file-name">Entrevista Dra E. Tutuni</span>
                                </a>
                        
                        </div>
                        <div class="col-md-4 col-sm-6 text-center">
                                <a href="extractos_prensa/file.php?src=fichaPolicialTutuni" class="link_directorio">
                                        <div class="icon-files file"></div>
                                        <span class="file-name">Ficha Policial Dra. Tutuni</span>
                                </a>
                        </div>
