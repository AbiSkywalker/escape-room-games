<?php
 ...
 $arraydocs = array('entrevistaKobalt' => ['entrevistaKobalt.txt', 'Entrevista Dra. S. Kobalt'],
                 'digitalCNU' => ['digitalCNU.txt', 'Entrevista Digital CNU'],
                 'productoresArroz' => ['productoresArroz.txt', 'Informe Producción de arroz'],
                 'entrevistaTutuni' => ['entrevistaTutuni.txt', 'Entrevista Dra. E. Tutuni'],
                 'fichaPolicialTutuni' => ['fichaPolicialTutuni.txt', 'Ficha Policial Tutuni'],);
                 

$arrayimgs = array('tutuni' => 'tutuni.jpg', 'tutuni_archivo' => 'tutuni_archivo.jpg');
$imprimir = '<h5 class="col-lg-12 text-center">No tienes permiso para acceder a este archivo</h5>';
...
$permiso = false;
        ...
        } else if($_GET['img'] != '' && $arrayimgs[$_GET['img']] != ''){
                $permiso = true;
                $res = '<img class="img-fluid" src="'.$arrayimgs[$_GET['img']].'"/>';
        }
