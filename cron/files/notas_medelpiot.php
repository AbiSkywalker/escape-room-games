...
<title>CRON - Mis documentos/Notas Dr Medelpiot</title>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
                ...
                <nav class="navbar navbar-light bg-light justify-content-between navbar_directorio">
                  <span class="navbar-brand">Notas Dr. Medelpiot</span>
                ...
                <div class="row">
                        <div class="col-md-4 col-sm-6 text-center">
                                <a href="notas_medelpiot/imagen.php?img=laboratorioCiclope" class="link_directorio">
                                        <div class="icon-files imagen"></div>
                                        <span class="file-name">Laboratorio Cíclope</span>
                                </a>
                        
                        </div>
                        <div class="col-md-4 col-sm-6 text-center">
                                <a href="notas_medelpiot/imagen.php?img=laboratorioDragon" class="link_directorio">
                                        <div class="icon-files imagen"></div>
                                        <span class="file-name">Laboratorio Dragón</span>
                                </a>
                        
                        </div>
                        <div class="col-md-4 col-sm-6 text-center">
                                <a href="notas_medelpiot/imagen.php?img=laboratorioEsfinge" class="link_directorio">
                                        <div class="icon-files imagen"></div>
                                        <span class="file-name">Laboratorio Esfinge</span>
                                </a>
                        </div>
                        <div class="col-md-4 col-sm-6 text-center">
                                <a href="notas_medelpiot/imagen.php?img=laboratorioFenix" class="link_directorio">
                                        <div class="icon-files imagen"></div>
                                        <span class="file-name">Laboratorio Fénix</span>
                                </a>
                        </div>
                
                        <div class="col-md-4 col-sm-6 text-center">
                                <a href="notas_medelpiot/imagen.php?img=laboratorioGrifo" class="link_directorio">
                                        <div class="icon-files imagen"></div>
                                        <span class="file-name">Laboratorio Grifo</span>
                                </a>
                        
                        </div>
                        <div class="col-md-4 col-sm-6 text-center">
                                <a href="notas_medelpiot/imagen.php?img=laboratorioMedusa" class="link_directorio">
                                        <div class="icon-files imagen"></div>
                                        <span class="file-name">Laboratorio Medusa</span>
                                </a>
                        </div>
                        <div class="col-md-4 col-sm-6 text-center">
                                <a href="notas_medelpiot/imagen.php?img=proyectoCronos" class="link_directorio">
                                        <div class="icon-files imagen"></div>
                                        <span class="file-name">Proyecto Cronos</span>
                                </a>
                        </div>
               
                        <div class="col-md-4 col-sm-6 text-center">
                                <a href="notas_medelpiot/imagen.php?img=accesoCastillo" class="link_directorio">
                                        <div class="icon-files imagen"></div>
                                        <span class="file-name">Acceso al castillo</span>
                                </a>
                        
                        </div>
                        <div class="col-md-4 col-sm-6 text-center">
                                <a href="notas_medelpiot/imagen.php?img=nanoChip" class="link_directorio">
                                        <div class="icon-files imagen"></div>
                                        <span class="file-name">Circuito Nanochip CR-27</span>
                                </a>
                        </div>
                        <!--div class="col-md-4 col-sm-6 text-center">
                                <a href="notas_medelpiot/imagen.php?img='proyectoCronos'" class="link_directorio">
                                        <div class="icon-files imagen"></div>
                                        <span class="file-name">Imagen 1</span>
                                </a>
                        </div-->
