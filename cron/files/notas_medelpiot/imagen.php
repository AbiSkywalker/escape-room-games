...
$arrayimgs = array('proyectoCronos' => ['proyectoCronos.PNG', 'Proyecto Cronos'], 
                   'laboratorioCiclope' => ['laboratorioCiclope.png', 'Laboratorio Cíclope'],
                   'laboratorioDragon' => ['laboratorioDragon.png', 'Laboratorio Dragón'],
                   'laboratorioEsfinge' => ['laboratorioEsfinge.png', 'Laboratorio Esfinge'],
                   'laboratorioFenix' => ['laboratorioFenix.png', 'Laboratorio Fénix'],
                   'laboratorioGrifo' => ['laboratorioGrifo.png', 'Laboratorio Grifo'], 
                   'laboratorioMedusa' => ['laboratorioMedusa.png', 'Laboratorio Medusa'],  
                   'accesoCastillo' => ['accesoCastillo.jpg', 'Acceso al castillo'], 
                   'nanoChip' => ['nanoChip.jpg', 'Circuito Nanochip CR-27'], );

        if($_GET['img']!=''){
                $sourcefile = $arrayimgs[$_GET['img']][0];
                $namefile = $arrayimgs[$_GET['img']][1];
        }
...
<title>CRON - Mis documentos/Notas Dr Medelpiot/<?=$namefile?></title>
