      ...
      <div class="row">
        ...
        <div class="col-md-8">
                ...
                <nav class="navbar navbar-light bg-light justify-content-between navbar_directorio">
                  <span class="navbar-brand">Mis Documentos</span>
                ...
                <div class="row">
                        <div class="col-md-4 col-sm-6 text-center">
                                <a href="files/prensa.php" class="link_directorio">
                                        <div class="icon-files folder"></div>
                                        <span class="file-name">Extractos de prensa</span>
                                </a>
                        
                        </div>
                        <div class="col-md-4 col-sm-6 text-center">
                                <a href="files/notas_medelpiot.php" class="link_directorio">
                                        <div class="icon-files folder"></div>
                                        <span class="file-name">Notas Dr. Medelpiot</span>
                                </a>
                        </div>
                        <div class="col-md-4 col-sm-6 text-center">
                                <a href="files/docs_internos.php" class="link_directorio">
                                        <div class="icon-files folder"></div>
                                        <span class="file-name">Documentos internos</span>
                                </a>
                        </div>
