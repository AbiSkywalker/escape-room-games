 ...
 $mensaje = "";
   ...
   if (isset($_GET["error"])){
           ...
           if (isset($_POST["nombregrupo"])){
                 ...
                 $query = $conn->prepare("SELECT id FROM equiposlunanegra WHERE nombre = ?");
                 ...
                 if($res){
                     ...
                     $query = $conn->prepare("INSERT INTO equiposlunanegra (nombre, idweb) VALUES (?, ?)");
                     ...
                     if($res){ 
                              ...
                              $mensaje .= "<form action='luna_negra/login_luna_negra.php' method='POST'><input name='idgrupo' type='hidden' value='".$idgrupo."'><input type='submit' value='Iniciar' class='btn btn-primary'/></form>";
                     }else{
                             //Otro error
...
<title>En busca de la Luna Negra - Escape Room Desde Casa</title>
<meta name="description" content="Juego de escape virtual Luna Negra" />
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 mx-auto">
          <h1 class="display-4 title" >&nbsp;&nbsp;En busca de la Luna Negra</h1>
                  ...
                  <?php if(!$isgroupcreated){ ?>      
                        ...
                        <div class="tab-content" id="gameoptionsContent">
                          ...
                          <div class="tab-pane fade" id="joingroup" role="tabpanel" aria-labelledby="joingroup-tab">
                                 ...
                                 <form action="luna_negra/login_luna_negra.php" method="POST" class="inlineform">
                                            <div class="form-group">
